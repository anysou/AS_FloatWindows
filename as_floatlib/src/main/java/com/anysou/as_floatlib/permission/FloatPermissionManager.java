 ...
 */
package com.anysou.as_floatlib.permission;
...
import com.anysou.as_floatlib.permission.rom.HuaweiUtils;
import com.anysou.as_floatlib.permission.rom.MeizuUtils;
import com.anysou.as_floatlib.permission.rom.MiuiUtils;
import com.anysou.as_floatlib.permission.rom.QikuUtils;
import com.anysou.as_floatlib.permission.rom.RomUtils;
        ...
        showConfirmDialog(context, new OnConfirmResult() {
            ...
            public void confirmResult(boolean confirm) {
                if (confirm) {
                    ...
                    Log.e(TAG, "ROM:360, 用户手动拒绝浮动窗口权限");
                }
            }
        });
    }
        ...
        showConfirmDialog(context, new OnConfirmResult() {
            ...
            public void confirmResult(boolean confirm) {
                if (confirm) {
                    ...
                    Log.e(TAG, "ROM:huawei华为, 用户手动拒绝浮动窗口权限");
                }
            }
        });
    }
        ...
        showConfirmDialog(context, new OnConfirmResult() {
            ...
            public void confirmResult(boolean confirm) {
                if (confirm) {
                    ...
                    Log.e(TAG, "ROM:meizu魅族, 用户手动拒绝浮动窗口权限");
                }
            }
        });
    }
        ...
        showConfirmDialog(context, new OnConfirmResult() {
            ...
            public void confirmResult(boolean confirm) {
                if (confirm) {
                    ...
                    Log.e(TAG, "ROM:miui小米, 用户手动拒绝浮动窗口权限");
                }
            }
        });
    }
